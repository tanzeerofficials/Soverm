...
assert.equal(getChatFinancialSnapshot(userId, syncAt), null, 'empty cache misses')

setChatFinancialSnapshot(userId, syncAt, snapshot, Date.parse('2026-07-18T12:01:00.000Z'))
...
assert.equal(
  getChatFinancialSnapshot(userId, '2026-07-18T13:00:00.000Z'),
  null,
...
setChatFinancialSnapshot(userId, syncAt, snapshot)
invalidateChatFinancialSnapshot(userId)
assert.equal(getChatFinancialSnapshot(userId, syncAt), null, 'invalidate clears')
