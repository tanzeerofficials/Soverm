 ...
 *
 * Compact Overview card — recurring charges preview and a link into the
 * Expense Analyzer.
 */
    ...
    return (
      <section className="rounded-xl border border-border-default bg-surface p-4 sm:p-5 card-shadow">
        ...
        <p className="mt-3 text-sm text-fg-muted">
          Sync your transactions and check back — subscriptions will show up here.
        </p>
        <Link
          to="/expense-analyzer"
    ...
    <section className="rounded-xl border border-border-default bg-surface p-4 sm:p-5 card-shadow">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-xs text-fg-muted">Recurring charges · last 30 days</p>
        </div>
        <Link
          to="/expense-analyzer"
