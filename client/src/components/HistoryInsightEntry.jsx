  ...
  return (
    <div className={`relative ${showTimeline ? 'pl-8' : ''}`}>
      ...
      <button
        ...
        className="group flex w-full flex-col overflow-hidden rounded-xl border border-border-default border-l-4 border-l-ai bg-surface text-left card-shadow transition hover:border-border-hover hover:bg-surface-elevated/40 hover:shadow-md"
      >
